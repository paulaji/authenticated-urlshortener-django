...
# part of simplejwt, jwt customization
...
# to customize the way our jwt can work
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=5),
    "REFRESH_TOKEN_LIFETIME": timedelta(days=1),
    # setting refresh token rotation to true for more security
    "ROTATE_REFRESH_TOKENS": True,
    # blacklisting once used refresh tokens
    ...
    # setting refresh token lifetime to be higher than 1 day
